...
public class AddProducerCreditView extends JPanel implements ActionListener {
	
	private Media media;
	private String makerName;
	
	public AddProducerCreditView(){
		boolean movieFlag;
		String typeMedia;
		...
		JLabel panelLabel1 = new JLabel("Add Producer Credits for " + makerName);
		...
		JLabel detailsLabel1 = new JLabel("Credit Details");
		JLabel detailsLabel2 = new JLabel("If selecting 'other', fill in field: ");
		JRadioButton coProducer = new JRadioButton("Co-Producer");
		JRadioButton exProducer = new JRadioButton("Executive Producer");
		JRadioButton other = new JRadioButton("Other");
		JTextField otherDetails = new JTextField("",15);
		otherDetails.setHorizontalAlignment(JTextField.CENTER);
		
		ButtonGroup producers = new ButtonGroup();
		producers.add(coProducer);
		producers.add(exProducer);
		...
		c.gridx = 0;
		c.gridy = 0;
		actorSubPanel.add(coProducer,c);
		c.fill = GridBagConstraints.CENTER;
		c.gridx = 1;
		c.gridy = 0;
		actorSubPanel.add(exProducer,c);
		c.fill = GridBagConstraints.WEST;
		c.gridx = 0;
		c.gridy = 1;
