...
public class AddDirectorCreditView extends JPanel implements ActionListener {
	
	private Media media;
	private String makerName;
	
	public AddDirectorCreditView(){
		boolean movieFlag;
		String typeMedia;
		...
		JLabel panelLabel1 = new JLabel("Add Director Credits for " + makerName);
		...
		JRadioButton coDirector = new JRadioButton("Co-Director");
		...
		c.gridx = 0;
		c.gridy = 0;
		actorSubPanel.add(coDirector,c);
		c.fill = GridBagConstraints.CENTER;
		c.gridx = 1;
		c.gridy = 0;
